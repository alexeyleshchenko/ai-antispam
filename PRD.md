...
5. **«Безобидный текст → правка»**: Сначала безобидное сообщение, затем редактирование того же `message_id` в спам; см. `docs/spamTactics.md` (§10). На испытательном сроке правки снова проходят модерацию.
